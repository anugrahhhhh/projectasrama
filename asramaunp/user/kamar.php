            ...
            <div class="kamar">
                ...
                <table>
                    <tr>
                        <td>
                            <center>
                                ...
                                <div class="tipekamar">Jumlah <?php echo $stok ?> Tersedia</div>
                    ...
                    <tr>
                        <td>
                            <center>
                                <input type="submit" name="klik" value="Pesan" style="width:70px;background-color:#00fbff;color:black;font-weight:bold;padding:4px;border:1px solid black; border-radius: 5px;">
                            </center>
                        </td>
                    </tr>
                </table>
