...
<html>
<head>
	<title>Sistem Informasi Pemesanan Kamar Pada Asrama Universitas Negeri Padang Pesel</title>
	<meta charset="utf-8">
...
<body>
	<nav>
			<img src="http://web.unp.ac.id/sites/default/files/inline-images/logo%20UNP.png" width="80px"> <span style="float: right; margin-right: 80px;"><center><img src="../simpangambar/<?php 
				if ($foto != '') {
					echo $foto;
				}
				else {
