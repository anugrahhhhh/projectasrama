...
<aside style="height: auto; margin-bottom: 5px;">
    <center>
        ...
        <div id="rekening" style="width: 60%; height: 200px;">
            <li>Rekening Asrama Universitas Negeri Padang Pesel</li>
                ...
                <div id="pesankamar">
                    <table width="300px">
                        ...
                        <tr>
                            <?php
                            if ($status == "Berhasil") {
                                echo '<td colspan="2" align="center" style="background: green;color: white;">Status Transaksi : ' . $status . '</td>';
                            } else if ($status == "Pending...") {
                                echo '<td colspan="2" align="center" style="background: blue;color: white;">Status Transaksi : ' . $status . '</td>';
                            } else {
                                echo '<td colspan="2" align="center" style="background: black;color: white;">Status Transaksi : ' . $status . '</td>';
                            }
                            date_default_timezone_set("Asia/Makassar");
                            $tglsekarang = date('Y-m-d H:i:s');
                            if ($tglsekarang > $batasbayar) {
                                echo '<script>console.log("Dibatalkan");</script>';
                                ...
                                if ($status == "Pending...") {
                                    ...
                                    if ($idbayar == $idpesan) {
                                        echo '<td colspan="2" align="center" style="background: yellow; color: black;">Status Transaksi : Menunggu Verifikasi Pembayaran</td>';
                                    } else {
                                        echo '<tr><td colspan="2" align="center" style="background:#B40301;">Status Transaksi : Menunggu Proses Pembayaran</td></tr>';
                                        echo '<tr><td colspan="2" align="center" style="background:#B40301;">Segera Lakukan Pembayaran Sebelum :</td></tr>';
                                        echo '<tr><td colspan="2" align="center" style="background:#B40301;">Tanggal : ' . $batasbayarr . '<br>Jam : ' . $batasjam . '</td></tr>';
                                        echo '<tr><td colspan="2" align="center" style="background:#B40301;">Jika Tidak Transaksi Anda Dibatalkan</td></tr>';
                                        echo '<tr><td colspan="2" align="center"><a href="bayar.php?id=' . $idpesan . '"><button id="bbayar" style="width:150px;background:yellow;color:black;font-weight:bold;padding:4px;border:2px solid white; margin-bottom: 3px;">Konfirmasi Pembayaran</button></a></td></tr>';
                                    }
                                }
                            }
                            ?>
